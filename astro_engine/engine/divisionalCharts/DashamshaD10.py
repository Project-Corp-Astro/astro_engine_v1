...
def get_nakshatra_and_pada(longitude):
    ...
    pada_index = int((lon % nakshatra_size) / pada_size) + 1  # Pada 1–4
...
def lahairi_Dashamsha(data):
    ...
    try:
        ...
        for planet, (d10_lon, retro) in d10_positions.items():
            ...
            nakshatra, pada = get_nakshatra_and_pada(d10_lon)
        ...
        asc_nakshatra, asc_pada = get_nakshatra_and_pada(d10_asc_lon)
        ascendant_json = {
